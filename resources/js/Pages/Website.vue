    ...
    <AuthenticatedLayout>
        ...
        <div class="flex flex-wrap justify-center px-8 space-x-4"> 
            ...
            <div class="custom-chart-width p-4 border border-black rounded-lg mt-10"> <!-- Add padding, border, and rounded corners -->
                <canvas id="visitorsViewsChart" class="w-full" style="height: 360px;"></canvas> <!-- Set height using inline style -->
            </div>

            <!-- Retention Rate Chart -->
            <div class="custom-chart-width p-4 border border-black rounded-lg mt-10"> <!-- Add padding, border, and rounded corners -->
                <canvas id="engagementRateChart" class="w-full" style="height: 360px;"></canvas> <!-- Set height using inline style -->
            </div>
        </div>
