            ...
            <div class="container mx-auto p-4 flex flex-col md:flex-row">
                ...
                <div class="w-full md:w-1/2 flex flex-col items-center mt-8 md:mt-0 py-0">
                    <div class="relative group">
                        ...
                        <!-- This input now covers the entire profile picture for easy clicking -->
                        <input
                            type="file"
                            id="profile-upload"
                        ...
                        <label for="profile-upload" class="absolute bottom-0 right-0 bg-gray-800 text-white p-2 rounded-full cursor-pointer flex items-center justify-center w-8 h-8 z-30">
                            <i class="fas fa-camera"></i>
                        </label>

                        <!-- Centered overlay for hover effect -->
                        <div class="absolute inset-0 pl-5 bg-gray-800 bg-opacity-50 flex items-center justify-center text-white text-sm font-bold opacity-0 rounded-full group-hover:opacity-100 transition-opacity z-10">
                    ...
                    <div class="mt-6 w-3/4 space-y-4">
                        <div class="mb-4">
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 mr-1" viewBox="0 0 24 24">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 mr-1" viewBox="0 0 48 48">
